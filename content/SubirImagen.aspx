<%@ Page MasterPageFile="~/shared/LateralBar.master" Title=".:: ASP - Formulario de Registro ::." Language="C#" AutoEventWireup="true" CodeFile="SubirImagen.aspx.cs" Inherits="content_SubirImagen" %>


<asp:Content ID="contentLayoutSubirImagen" ContentPlaceHolderID="contentLayout" runat="Server">
    <div>&nbsp;</div>
    <div class="col-lg-3">
        <div class="container">
        ...
        <div class="container well">
            <form id="personDataForm" class="form-horizontal" runat="server">
                <fieldset>
                    <legend>Formulario de Registro (Con Imagen)</legend>
                    <div class="row">
                        <div class="col-lg-2 col-lg-offset-1">
                            <asp:Image ID="personPhotoImage" runat="server" ImageUrl="~/assets/img/profile-placeholder.png" alt="Photo" CssClass="img-thumbnail" Height="140" Width="140" />
                        </div>
                        <div class="col-lg-9">
                            <div class="form-group col-lg-12">
                                <div class="input-group">
                                    <span class="input-group-btn">
                                        <span class="btn btn-primary btn-file">
                                            <i class="fa fa-upload"></i>Subir Fotograf&iacute;a
                                    <asp:FileUpload runat="server" accept="image/*"
                                        CssClass="form-control file_upload"
                                        ID="personPhotoFile"
                                        data-ajaxid="photo"
                                        required="required" />
                                        </span>
                                ...
                                <span class="help-block">El archivo a subir debe estar en un formato de imagen. <sup><span class="text-danger"><small><i class="fa fa-asterisk"></i></small></span></sup>
                                </span>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function () {
            $("#<%=personPhotoFile.ClientID%>").change(function () { tempUpload(this) });
            tempUpload = function (e) {
                if (e.files && e.files[0]) {
                    var reader = new FileReader();
                    $(reader).load(function (e) { $("#<%=personPhotoImage.ClientID%>").attr("src", e.target.result); });
